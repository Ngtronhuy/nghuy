package fpt.huyntph.lap1.demo3;
...
public class Demo3MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2 = findViewById(R.id.demo3btn2);
        btn3 = findViewById(R.id.demo3btn3);
        btn4 = findViewById(R.id.demo3btn4);
        ...
        btn4.setOnClickListener(v -> {
            ...
            View view1 = inflater.inflate(R.layout.demo3_loginform,null);
            builder.setView(view1); // dua view vao builder
            // anh xa cac thanh phan
            final EditText txtUser = (EditText) view1.findViewById(R.id.demo3_loginform_txtU);
            final  EditText txtPass = (EditText) view1.findViewById(R.id.demo3_loginform_txtP);
